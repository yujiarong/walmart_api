<?php
namespace GuzzleHttp5\Command;

use GuzzleHttp5\ClientInterface;
use GuzzleHttp5\Collection;
use GuzzleHttp5\Command\Event\InitEvent;
use GuzzleHttp5\Command\Event\PreparedEvent;
use GuzzleHttp5\Command\Event\ProcessEvent;
use GuzzleHttp5\Command\Exception\CommandException;
...
abstract class AbstractClient implements ServiceClientInterface
{
    ...
    {
        $cn = 'GuzzleHttp5\\Command\\Exception\\CommandException';
        ...
        if ($transaction->response) {
            ...
            if ($statusCode[0] == '4') {
                $cn = 'GuzzleHttp5\\Command\\Exception\\CommandClientException';
            } elseif ($statusCode[0] == '5') {
                $cn = 'GuzzleHttp5\\Command\\Exception\\CommandServerException';
            }
        }
