...
use GuzzleHttp5\Ring\FutureInterface;
...
interface ServiceClientInterface extends HasEmitterInterface
{
     ...
     *
     * @throws \Exception
     * @see \GuzzleHttp5\Command\ServiceClientInterface::getCommand
     */
     ...
     * @see GuzzleHttp5\Command\ServiceClientInterface::createCommandPool for
     *      a list of options.
     */
