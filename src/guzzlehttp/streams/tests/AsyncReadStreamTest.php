...
use GuzzleHttp5\Stream\AsyncReadStream;
use GuzzleHttp5\Stream\BufferStream;
use GuzzleHttp5\Stream\FnStream;
...
class AsyncReadStreamTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreatesBufferWithNoConfig()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp5\Stream\BufferStream', $buffer);
        $this->assertInstanceOf('GuzzleHttp5\Stream\AsyncReadStream', $async);
    }
    ...
    public function testCreatesNullStream()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp5\Stream\NullStream', $buffer);
        $this->assertInstanceOf('GuzzleHttp5\Stream\AsyncReadStream', $async);
    }
    ...
    public function testCreatesDroppingStream()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp5\Stream\DroppingStream', $buffer);
        $this->assertInstanceOf('GuzzleHttp5\Stream\AsyncReadStream', $async);
    ...
    public function testCreatesOnWriteStream()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp5\Stream\FnStream', $buffer);
        $this->assertInstanceOf('GuzzleHttp5\Stream\AsyncReadStream', $async);
