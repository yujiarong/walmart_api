...
/**
 * @covers GuzzleHttp5\Stream\Stream
 */
class StreamTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreatesWithFactory()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp5\Stream\Stream', $stream);
        $this->assertEquals('foo', $stream->getContents());
        $stream->close();
    }
    ...
    {
        $s = Stream::factory();
        $this->assertInstanceOf('GuzzleHttp5\Stream\Stream', $s);
    }
    ...
    public function testCanCreateIteratorBasedStream()
    {
        ...
        $p = Stream::factory($a);
        $this->assertInstanceOf('GuzzleHttp5\Stream\PumpStream', $p);
