...
use GuzzleHttp5\Ring\Client\ClientUtils;
...
class StreamHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAddsErrorToResponse()
    {
        ...
        $this->assertInstanceOf(
            'GuzzleHttp5\Ring\Future\CompletedFutureArray',
            $result
        );
        ...
        $this->assertInstanceOf(
            'GuzzleHttp5\Ring\Exception\RingException',
            $result['error']
        );
    }
    ...
    public function testDrainsResponseIntoSaveToBodyAtPath()
    {
        ...
        $body = $response['body'];
        $this->assertInstanceOf('GuzzleHttp5\Stream\StreamInterface', $body);
