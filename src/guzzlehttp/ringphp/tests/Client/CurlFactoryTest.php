...
namespace GuzzleHttp5\Ring\Client {
...
namespace GuzzleHttp5\Tests\Ring\Client {

use GuzzleHttp5\Ring\Client\CurlFactory;
...
class CurlFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFailsWhenNoResponseAndNoBody()
    {
        ...
        $this->assertInstanceOf('GuzzleHttp5\Ring\Exception\RingException', $res['error']);
        $this->assertContains(
    ...
    {
        $m = new \ReflectionMethod('GuzzleHttp5\Ring\Client\CurlFactory', 'createErrorResponse');
        ...
        $this->assertInstanceOf('GuzzleHttp5\Ring\Exception\ConnectException', $response['error']);
    }
