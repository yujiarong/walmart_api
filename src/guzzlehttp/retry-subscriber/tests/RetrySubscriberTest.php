<?php
namespace GuzzleHttp5\Tests\Subscriber\RetrySubscriber;

use GuzzleHttp5\Client;
use GuzzleHttp5\Exception\ConnectException;
...
use GuzzleHttp5\Subscriber\Log\SimpleLogger;
...
class RetrySubscriberTest extends \PHPUnit_Framework_TestCase
{
    ...
    private function createEvent(
        ...
        array $transferInfo = [],
        $type = 'GuzzleHttp5\Event\AbstractTransferEvent'
    ) {
        if (!$request) {
